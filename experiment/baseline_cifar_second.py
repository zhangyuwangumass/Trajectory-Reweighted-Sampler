...
np.savez('bin/record/baseline_cifar_clean_second', his=his, index=class_index, train_recall=train_recall, val_recall=val_recall)
...
for i in range(1, 5):
    ...
    class_index = np.zeros((N, 1))
    np.savez('bin/record/baseline_cifar_error_0.' + str(i) + '_gaussian_0.1_second', his=his, index=class_index, train_recall=train_recall, val_recall=val_recall)
